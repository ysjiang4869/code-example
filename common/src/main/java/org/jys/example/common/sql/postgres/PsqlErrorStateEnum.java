...
public enum PsqlErrorStateEnum {
     ...
     * copy format error
     */
    BAD_COPY_FILE_FORMAT("22P04", "COPY_FILE_FORMAT_ERROR"),

    /**
     * table not exist
     */
    TABLE_NOT_FOUND("42P01", "TABLE_NOT_FOUND_ERROR"),
    ...
    PsqlErrorStateEnum(String sqlState, String message) {
    ...
    public static PsqlErrorStateEnum getErrorEnumBySqlState(String state) {
        for (PsqlErrorStateEnum errorStateEnum : PsqlErrorStateEnum.values()) {
